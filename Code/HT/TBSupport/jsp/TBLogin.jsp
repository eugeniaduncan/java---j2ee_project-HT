...
<%!
	...
	private LogOutput log          = new LogOutput("TBLogin");
	...
	if (request.getParameter("submit") != null)
	{
		...
		if (validateForm())
		{
			...
			if (validateEntries())
			{
				...
				log.debug("Forward to TBSelection.jsp.");
...
<br>
<br>
<center><h1><strong><font face="times" size="+5">TOOLBOX SUPPORT LOGIN PAGE</font></strong></h1></center>
<br>
<br>
<center>
...
<br>
<center>
<form name="form1" method="post" action="/jsp/TBLogin.jsp">
