...
<%
	...
	LogOutput log = new LogOutput("SCError");
	...
	try 
	{
		 ...
		 html_data.append("<head><title>Configuration Login</title></head>");
		 html_data.append("<body>");
		 html_data.append("<form method=\"post\" action=\"/jsp/SCLogin.jsp\">");
